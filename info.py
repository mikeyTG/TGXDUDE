...
API_ID = int(environ.get('API_ID', '26974083'))
API_HASH = environ.get('API_HASH', 'e013696bd13ea9495b803a679852da59')
BOT_TOKEN = environ.get('BOT_TOKEN', '6141743333:AAHrC11ZFQa-XJIy0K6zrn5j1sItD1PzPmk')

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', False))
PICS = (environ.get('PICS', 'https://telegra.ph/file/10009136df7620d9d3e5a.jpg')).split()
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001591139633').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('AUTH_CHANNEL', '-1001677223924')
...
FILE_FORWARD = environ.get('FILE_FORWARD',"https://t.me/+YkGthFjwHBpmZDY1")
MSG_ALRT = environ.get('MSG_ALRT', '𝑪𝑯𝑬𝑪𝑲 & 𝑻𝑹𝒀 𝑨𝑳𝑳 𝑴𝒀 𝑭𝑬𝑨𝑻𝑼𝑹𝑬𝑺')
FILE_CHANNEL = int(environ.get('FILE_CHANNEL', -1001928955385))
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1001167461473))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'jackeybots_support')
